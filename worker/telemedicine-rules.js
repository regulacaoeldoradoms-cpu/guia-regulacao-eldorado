...
const SPECIALTY_CANONICAL_BY_KEY = Object.freeze({
  ...
  ENDOCRINOLLOGISTA: 'ENDOCRINOLOGIA',
  NEFRO: 'NEFROLOGIA',
  NEFROLOGIA: 'NEFROLOGIA',
  NEFROLOGISTA: 'NEFROLOGIA',
  NEURO: 'NEUROLOGIA ADULTO',
  NEUROLOGIA: 'NEUROLOGIA ADULTO',
  'NEUROLOGIA ADULTO': 'NEUROLOGIA ADULTO',
  NEUROLOGISTA: 'NEUROLOGIA ADULTO',
  ...
  REMATOLOGIA: 'REUMATOLOGIA',
  REUMATO: 'REUMATOLOGIA',
  REUMATOLOGIA: 'REUMATOLOGIA',
  REUMATOLOGISTA: 'REUMATOLOGIA'
});

export function canonicalSpecialtyName(value) {
  const original = clean(value, 120);
  if (!original) return '';
  return SPECIALTY_CANONICAL_BY_KEY[normalizeText(original)] || original;
}
