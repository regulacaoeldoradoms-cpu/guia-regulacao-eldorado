...
function fastIntegratedAnalysisQuestion() {
  return [
    ...
    'Para es, use primeiro rótulo explícito de Especialidade; sem ele, aceite Solicitação/Solicitação de agendamento/Solicitação médica/Serviço solicitado quando o valor for o próprio nome da especialidade, como Cirurgia Geral, Cirurgia Vascular ou Ortopedia.',
    'Não converta procedimento ou exame em especialidade e nunca deduza es por CID, diagnóstico, motivo, sintomas, título ou conhecimento externo.',
