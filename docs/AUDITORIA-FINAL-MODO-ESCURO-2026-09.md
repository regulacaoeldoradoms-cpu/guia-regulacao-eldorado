...
**Resultados finais — ACEITE TÉCNICO DA MATRIZ:** run **36153569515**, head `6f027235b134cf798e3d3be80ce94c21011f2727`: **210/210 testes aprovados**, zero skips, zero falhas e zero flaky. Foram exercitados **404 estados renderizados**, 296 no tema escuro; **103.397 elementos visíveis** e **1.705 pseudo-elementos** foram inspecionados; **zero superfícies claras inesperadas** e **zero endpoints sintéticos desconhecidos**. As **120 comparações contra a main** concluíram com proveniência de raiz registrada; 112 foram PNG-exatas/dentro do limite original e os demais casos ficaram apenas nas classes de raster diagnóstico documentadas, sempre com computed/layout idêntico e zero erro JavaScript novo. A suíte permaneceu isolada em loopback, sem produção, dados reais, Drive, Worker ou telemetria.
