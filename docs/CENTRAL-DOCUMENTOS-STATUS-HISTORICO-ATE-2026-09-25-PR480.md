...
Integração:
- **PR #482 — Login: adicionar botão para mostrar ou ocultar senha**;
- head final: `9882c9e07a0b092ba552f4225359578305273961`;
- matriz da PR: **23/23 workflows GitHub Actions concluídos com success**, incluindo **Validar abertura pós-login — navegador**;
- merge na `main`: **`a831cb6ad7d8b193c0b858fb3e48d692257a177d`**.
...
**Próxima ação exata:** confirmar a publicação estática do merge `a831cb6a` e, em produção, validar que o olho mostra/oculta a senha sem alterar o login por Enter, autocomplete ou modo escuro/mobile.
...
- Salvar PDF e Imprimir possuem hierarquia visual própria em azul e não foram descaracterizados; os estados do Drive também permanecem com sua semântica visual.

Implementação integrada:
- branch funcional `fix/titon-dark-transparent-lineart-v1-20260924`, criada da `main` `16ecada6e766a23964e18251ff34932be412e46a`;
- PR funcional **#476 — Titon: line-art branca com fundo transparente no modo escuro**;
- head final da PR: `23ffdcaa422e858cb3a7e4e91ecd32234a47e845`;
- merge na `main`: **`2802ae45fbec29624cc6f3ba01c3ac0ad25ba6e9`**;
- controles genéricos do editor e rail lateral: fundo transparente, borda normal transparente, texto/SVG branco;
...
- versões line-art sem placa para `zoom-menos`, `zoom-mais`, `ajustar-largura`, `grade` e `fechar`;
- indicador percentual de zoom também transparente no modo escuro;
...
- cache-buster de `documents.css`: `20260924-2`.

Validação e publicação:
- PR #476: **23/23 workflows GitHub Actions concluídos com success**, incluindo **Validar Central de Documentos — navegador** com PDF.js real em Chromium;
- pós-merge `2802ae45`: **23/23 workflows de push concluídos com success**;
- GitHub Pages `pages build and deployment`: **success**;
- Cloudflare Pages: **success**;
- Workers Builds do Worker institucional: **success**;
- nenhuma falha ou regressão automatizada conhecida nesta unidade.
